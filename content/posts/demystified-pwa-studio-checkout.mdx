...
<Callout type={'warning'}>
  The Blogpost is based Check / Money Order feature in the development branch
  will be available via scaffolding early on <b>April 6, 2021</b>. I will update
  this Blogpost with every release and checkout change.
</Callout>
